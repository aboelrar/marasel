...
//    public ArrayList<www.gift_vouchers.marasel.MainScreen.ui.Product.Model.ImgList> getListObject(String key, Class<?> mClass){
//    	Gson gson = new Gson();
//
...
//    }
    ...
    public void putListImgList(String key, ArrayList<ImgList> ImgList_){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ImgList ImgList: ImgList_){
            objStrings.add(gson.toJson(ImgList));
        }
        putListString(key, objStrings);
    }

    //No need Class<?> mClass parameter. Because we know it is Player!
    public ArrayList<ImgList> getListImgList(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ImgList> playerList =  new ArrayList<ImgList>();

        for(String jObjString : objStrings){
            ImgList player  = gson.fromJson(jObjString,  ImgList.class);
...
//    }
    ...
    public void putListObject(String key, ArrayList<ImgList> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
