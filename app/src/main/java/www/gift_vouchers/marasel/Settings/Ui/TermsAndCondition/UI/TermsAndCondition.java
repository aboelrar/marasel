package www.gift_vouchers.marasel.Settings.Ui.TermsAndCondition.UI;
...
import www.gift_vouchers.marasel.databinding.TermsAndConditionBinding;
...
public class TermsAndCondition extends Fragment {
    ...
    Datum datum;
    TermsAndConditionBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.terms_and_condition, container, false);
    ...
    private void getData() {
        ...
        marsilInfoModelView.MutableLiveData.observe(this, new Observer<AppInfoRoot>() {
            ...
            public void onChanged(AppInfoRoot appInfoRoot) {
                ...
                binding.terms.setText(datum.getHowUse());
            }
        });
    }
}