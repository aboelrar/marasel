...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.CategoriesHolder> {
    Context context;
    ArrayList<SearchList> myList;

    public SearchAdapter(Context context, ArrayList<SearchList> myList) {
